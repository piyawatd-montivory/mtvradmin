...
<div class="container-fluid mt-5">
    <div class="h3 border-bottom border-primary text-primary">
        User : @if($data->id == '') New @else {{$data->firstname}} {{$data->lastname}} @endif
    </div>
    <!-- Content Row -->
    <div class="row">
        <div class="col-md-12">
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-xl">
      <div class="modal-content">
        <div class="modal-header">
            ...
            <h5 class="modal-title" id="pennameModalLabel">Pen Name</h5>
        </div>
        <div class="modal-body">
            <div class="mb-3 row">
                <label for="m-penname" class="col-2 form-label">Name</label>
                <div class="col-10">
                    <input type="text" class="form-control" id="m-penname" placeholder="Name">
                    <input type="hidden" id="m-default">
